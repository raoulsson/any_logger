...
const kAnyLogDartConfigWithMDC = {
  'appenders': [
    {
      'type': 'CONSOLE',
      'format':
  ...
  Future<void> runMDC() async {
    ...
    await runZonedGuarded(() async {
      ...
      if (Zone.current[LOG_SESSION_HASH_KEY] != null) {
        ...
        Zone.current[LOG_SESSION_HASH_KEY]
            .add(generateMd5Fingerprint('Some data like app start timestamp'));
      }
      ...
      LOG_DEVICE_HASH_KEY: [
        generateMd5Fingerprint(
            'Data that is consistent per platform like values delivered by device_info_plus')
      ],
