...
class ConsoleAppender extends Appender {
  ...
  @override
  String toString() {
    return super.toString() + ' ' + 'ConsoleAppender(mode: $mode, sequenceNumber: $sequenceNumber, level: $level, format: $format, dateFormat: $dateFormat, created: $created, enabled: $enabled)';
  }
